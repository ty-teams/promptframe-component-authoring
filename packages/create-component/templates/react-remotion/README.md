...
版本事实：Current npm registry baseline is `@promptframe/cli@0.1.22`, `@promptframe/contracts@0.1.9`, and `create-promptframe-component@0.1.13`. The published CLI consumes the contracts AST-aware public security policy evaluator and reports `securityPolicyDigest` / `securityEvaluatorMode` in JSON output.
