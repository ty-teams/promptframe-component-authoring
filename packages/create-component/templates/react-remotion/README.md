...
版本事实：Current npm registry baseline is `@promptframe/cli@0.1.34`, `@promptframe/contracts@0.1.13`, `@promptframe/component-kit@0.1.11`, and `create-promptframe-component@0.1.24`. The published CLI consumes the contracts AST-aware public security policy evaluator, supports pnpm workspace root lockfile evidence, and reports `securityPolicyDigest` / `securityEvaluatorMode` / `publicResources` in JSON output.
