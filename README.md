...
Current registry baseline before the next component-kit release: `@promptframe/contracts@0.1.2`, `@promptframe/component-kit@0.1.3`, `@promptframe/cli@0.1.3`, `create-promptframe-component@0.1.1`. The checked-in `@promptframe/component-kit@0.1.5` release candidate sources its public standard stamp from `@promptframe/contracts`.
